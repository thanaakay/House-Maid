  ...
  (e.prototype.init = function () {
          ...
          a = function (a) {
            ...
            a.preventDefault(),
              o.disabled ||
                (t.options.setHash &&
                  (history.pushState
                    ? history.pushState(null, null, o.selector)
    ...
    (e.prototype._openTab = function (s, a, e, o) {
      ...
      e && this._closeTab(s, this._getCurrentTab()),
        ...
        (a.active = !0),
        a.tab
          .removeClass(i.options.classes.stateDefault)
          .addClass(i.options.classes.stateActive),
        a.accordionTab
          .removeClass(i.options.classes.stateDefault)
          .addClass(i.options.classes.stateActive),
        i._doTransition(a.panel, i.options.animation, "open", function () {
          a.panel
            .removeClass(i.options.classes.stateDefault)
            .addClass(i.options.classes.stateActive),
            "accordion" !== i.getState() ||
              !i.options.scrollToAccordion ||
              (i._isInView(a.accordionTab) &&
                "default" === i.options.animation) ||
              ("default" !== i.options.animation && i.options.duration > 0
                ? t("html, body").animate(
                    { scrollTop: a.accordionTab.offset().top },
                    i.options.duration
                  )
                : t("html, body").scrollTop(a.accordionTab.offset().top));
        }),
    ...
    (t.fn.responsiveTabs = function (s) {
      ...
      return s === a || "object" == typeof s
        ...
        ? this.each(function () {
            ...
            a instanceof e &&
              "function" == typeof a[s] &&
              a[s].apply(a, Array.prototype.slice.call(o, 1)),
